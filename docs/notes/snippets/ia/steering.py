...
red_agent_image = pygame.image.load(path.join(*['shmup', 'snippets', 'ia', 'agent_red.png'])).convert_alpha()
green_agent_image = pygame.image.load(path.join(*['shmup', 'snippets', 'ia', 'agent_green.png'])).convert_alpha()
